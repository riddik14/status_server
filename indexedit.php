...
<html>
    ...
    <body>
      ...
      <input id="editMode" type="button" value="Modifica" checked="checked" class="btn btn-default pull-right" />
      <form class="form-inline" role="form" action="indexedit.php" method="post">
        <div class="form-group">
          <input type="text" class="form-control" id="name" name="name" placeholder="Nome">
        </div>
        <div class="form-group">
          <input type="text" class="form-control" onkeyup="javascript:checkForm(this)" id="host" name="host" placeholder="Dominio / IP">
        </div>
        <div class="form-group">
          <input type="text" size="5" class="form-control" id="port" name="port" placeholder="Porta">
        </div>
        <button type="submit" class="btn btn-default" id="add-button">Aggiungi</button>
      </form>
      <br>
      <footer>
          <a href="/status_server/index.php"> Salva</a>
